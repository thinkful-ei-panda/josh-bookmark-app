...
function generateAddScreen() {
  ...
  <form>
      ...
      <label for="star-rating-in-form">Rating</label>
      <section class="star-rating-in-form">
      <input type="radio" id="star" name="rating" value="5" checked/><label for="star5">5 stars</label>
      ...
      <input type="radio" id="star" name="rating" value="1" /><label for="star1">1 star</label>
        ...
        <input class="button-primary" type="submit" id="add-bookmark" required></input>
        </section>
    </form>
    </section>
    </section>
